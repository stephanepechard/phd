...
\draw (2.6+\shiftX,-0.4+\shiftY) node[anchor=east,font=\footnotesize] {modèle synthétique};
\draw (2.6+\shiftX,-0.9+\shiftY) node[anchor=east,font=\footnotesize] {données synthétiques};
\draw (2.6+\shiftX,-1.4+\shiftY) node[anchor=east,font=\footnotesize] {modèle MPEG};
\draw (2.6+\shiftX,-1.9+\shiftY) node[anchor=east,font=\footnotesize] {données MPEG};
